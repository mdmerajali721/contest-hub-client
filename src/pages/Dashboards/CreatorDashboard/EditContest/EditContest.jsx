...
const EditContest = () => {
  ...
  const onSubmit = (data) => {
    axiosSecure
      .patch(`/contests/${data._id}/update`, data)
      .then((res) => {
  ...
  return (
    <div className="w-full mt-28 md:mt-10">
      <title>ContestHub - Creator Edit Contest</title>
      <div className="mb-8">
        <h2 className="text-3xl font-extrabold text-green-500">Edit Contest</h2>
        <p className="text-gray-500">
          Update the required details of your contest.
        </p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <textarea
              ...
              className="w-full border border-gray-200 rounded-md px-3 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-green-600 resize-none"
            ></textarea>
            {errors.description && (
              ...
              <Controller
                ...
                render={({ field }) => (
                  <DatePicker
                    ...
                    className="w-full border border-gray-200 bg-base-200 rounded-md px-3 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-green-600"
                  />
                )}
              />
              {errors.deadline && (
